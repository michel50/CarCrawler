IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Helper_CreatePocoFromTableName]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Helper_CreatePocoFromTableName]
GO
SET ANSI_NULLS ON
GO
